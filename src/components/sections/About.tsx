            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>
                ...
                <strong className="text-foreground">
                  Senior React Native Developer & Full-Stack JavaScript Engineer
                </strong>{" "}
                based in Morocco, ready for international remote opportunities.
              </p>
              <p>
                With a deep focus on mobile development expertise and full-stack
                engineering, I enjoy bridging the gap between engineering and
                design. My product mindset drives me to build solutions that not
                only fulfill technical requirements but also deliver seamless
                user experiences.
              </p>
              <p>
                I am committed to continuous learning and staying updated with
                the latest industry trends. My experience architecting complex
                ecosystems—ranging from scalable backends to high-performance
                client apps—equips me to tackle challenging business problems
                effectively.
              </p>
            </div>
