      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-foreground/80 mb-6">
            Senior React Native Developer <br className="hidden md:block" /> & Full-Stack JavaScript Engineer
          </h2>

          <p className="text-lg text-muted-foreground mb-10 max-w-2xl leading-relaxed">
            I build scalable mobile and web products with a strong focus on user
            experience, performance, and maintainable architecture. Over the past four
            years, I have worked on enterprise-scale applications, e-commerce
            ecosystems, booking platforms, and real-time systems.
          </p>
          ...
          <div className="flex items-center gap-6 text-muted-foreground">
            <a href="https://github.com/bilal-prog" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              <GithubIcon size={28} />
            </a>
            <a href="https://ma.linkedin.com/in/bilal-hamdi-844b5220b" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              <LinkedinIcon size={28} />
            </a>
            <a href="mailto:contact@bilalhamdi.com" className="hover:text-white transition-colors">
              <Mail size={28} />
            </a>
          </div>
        </motion.div>
